...
def answer(request: AdminChatRequest, service: AdminChatService = Depends(), current_user: dict = Depends(get_current_user)):
    return service.answer(request, current_user)
